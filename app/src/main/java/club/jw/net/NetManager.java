...
import club.jw.net.captcha.ICaptcha;
import club.jw.net.entity.WebCookie;
import club.jw.net.entity.WebResponse;
import club.jw.net.parser.*;
import club.jw.net.entity.request.ClassesRequest;
import club.jw.net.entity.request.LoginRequest;
import club.jw.net.entity.request.PasswordRequest;
import club.jw.net.entity.request.Request;
import club.jw.net.entity.response.ErrorResponse;
import club.jw.net.entity.response.Response;
import club.jw.net.entity.response.SuccessResponse;
import club.jw.net.enums.Method;
...
public class NetManager {
    ...
    public static Response login(LoginRequest loginData){
        ...
        InputStream image = downImage("/captcha/image.action", main.getCookies());
    ...
    private static InputStream downImage(String imgUrl, WebCookie webCookie) {
        try {
